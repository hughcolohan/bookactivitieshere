...
function loadUpdateContent()
{
	...
	$(".update_in_page").qtip({content: { text: 'In Currentpage' }, position: { my: 'center left', at: ' center right' }, show: { event: 'mouseenter' }, hide: { event: 'mouseleave' }, style: { classes: 'ui-tooltip-shadow ui-tooltip-tipsy',  tip: {  corner: true, width: 5, height:8 } } });
...
function addonSuiteMiniLimitExceeded(mode) {
	...
	if(addonSuitePlanActivity=='installed' && isAddonPlanLimitExceeded==1) {
		...
		var refundMessage='';
		if (activeTierPlan == 'starter') {
			var addonSuitePrice = priceForAllPlans.priceExistingToDeveloper;
			var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="popular-banner popup" src="images/popupar-banner.svg" data-pin-nopin="true" style="margin-left: -44px;"><img class="developer-icon popup" src="images/developer.svg" data-pin-nopin="true" style="margin-left: -26px;"> <div class="plan-name popular popup">developer</div><div class="no-of-sites">'+(parseInt(allPlansSiteLimits.starterSiteLimit)+1)+'-'+allPlansSiteLimits.developerSiteLimit+' Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">1-2 Days E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;margin-top: 3px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ $'+priceForAllPlans.renewPriceForDeveloper+' yearly</div></div>';
			var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDExistingToDeveloper+'&utm_source=application&utm_medium=userapp&utm_campaign=developer';
			var additionalMessage = 'Your Starter plan license allows you to manage only upto '+miniSiteLimit+' sites.<br>';
			var suggestPlan = 'Developer';
			var suggestSite = (parseInt(allPlansSiteLimits.starterSiteLimit)+1)+'-'+allPlansSiteLimits.developerSiteLimit;
			
		}else if(activeTierPlan == 'developer'){
			var addonSuitePrice = priceForAllPlans.priceExistingToFreelancer;
			var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="freelancer-icon popup" src="images/freelancer.svg" data-pin-nopin="true" style="margin-top: -23px;margin-left: -17px;"> <div class="plan-name popular popup">freelancer</div><div class="no-of-sites">'+(parseInt(allPlansSiteLimits.developerSiteLimit)+1)+'-'+allPlansSiteLimits.freelancerSiteLimit+' Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">1 Day E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;margin-top: 3px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ $'+priceForAllPlans.renewPriceForFreelancer+' yearly</div></div>';
			var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDExistingToFreelancer+'&utm_source=application&utm_medium=userapp&utm_campaign=freelancer';
			var additionalMessage = 'Your Developer plan license allows you to manage only upto '+miniSiteLimit+' sites.<br>';
			var suggestPlan = 'Freelancer';
			var suggestSite = (parseInt(allPlansSiteLimits.developerSiteLimit)+1)+'-'+allPlansSiteLimits.freelancerSiteLimit;
		}else if(activeTierPlan == 'freelancer'){
			var addonSuitePrice = priceForAllPlans.priceExistingToAgency;
			var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="freelancer-icon popup" src="images/agency.svg" data-pin-nopin="true" style="margin-top: -23px;margin-left: -17px;"> <div class="plan-name popular popup">agency</div><div class="no-of-sites">Unlimited Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">Priority E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;margin-top: 3px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ $'+priceForAllPlans.renewPriceForAgency+' yearly</div></div>';
			var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDExistingToAgency+'&utm_source=application&utm_medium=userapp&utm_campaign=agency';
			var additionalMessage = 'Your Freelancer plan license allows you to manage only upto'+miniSiteLimit+' sites.<br>';
			var suggestPlan = 'Agency';
			var suggestSite = 'Unlimited';
		}
		if(isAddonPlanExpired) {
			if (activeTierPlan == 'starter') {
				var addonSuitePrice = priceForAllPlans.priceForDeveloper;
				var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="popular-banner popup" src="images/popupar-banner.svg" data-pin-nopin="true" style="margin-left: -44px;"><img class="developer-icon popup" src="images/developer.svg" data-pin-nopin="true" style="margin-left: -26px;"> <div class="plan-name popular popup">developer</div><div class="no-of-sites">'+(parseInt(allPlansSiteLimits.starterSiteLimit)+1)+'-'+allPlansSiteLimits.developerSiteLimit+' Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">1-2 Days E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;margin-top: 3px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ '+priceForAllPlans.renewPriceForDeveloper+' yearly</div></div>';
				var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDForDeveloper+'&utm_source=application&utm_medium=userapp&utm_campaign=developer';
				var additionalMessage = 'Your Starter plan license allows you to manage only upto '+miniSiteLimit+' sites.<br>';
				var suggestPlan = 'Developer';
				var suggestSite = (parseInt(allPlansSiteLimits.starterSiteLimit)+1)+'-'+allPlansSiteLimits.developerSiteLimit;

			}else if(activeTierPlan == 'developer'){
				var addonSuitePrice = priceForAllPlans.priceForFreelancer;
				var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="freelancer-icon popup" src="images/freelancer.svg" data-pin-nopin="true" style="margin-top: -23px;margin-left: -17px;"> <div class="plan-name popular popup">freelancer</div><div class="no-of-sites">'+(parseInt(allPlansSiteLimits.developerSiteLimit)+1)+'-'+allPlansSiteLimits.freelancerSiteLimit+' Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">1 Day E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ '+priceForAllPlans.renewPriceForFreelancer+' yearly</div></div>';
				var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDForFreelancer+'&utm_source=application&utm_medium=userapp&utm_campaign=freelancer';
				var additionalMessage = 'Your Developer plan license allows you to manage only upto '+miniSiteLimit+' sites.<br>';
				var suggestPlan = 'Freelancer';
				var suggestSite = (parseInt(allPlansSiteLimits.developerSiteLimit)+1)+'-'+allPlansSiteLimits.freelancerSiteLimit;

			}else if(activeTierPlan == 'freelancer'){
				var addonSuitePrice = priceForAllPlans.priceForAgency;
				var planRecomend = '<div class="popular popup stroke-color tiered-plan" style="margin-top: 29px;margin-left: 45px;"><img class="freelancer-icon popup" src="images/agency.svg" data-pin-nopin="true" style="margin-top: -23px;margin-left: -17px;"> <div class="plan-name popular popup">agency</div><div class="no-of-sites">Unlimited Sites</div><div class="w-clearfix"><a class="all-addons-link popup w-clearfix w-inline-block" href="https://infinitewp.com/addon/" target="_blank"><img class="all-addon-icon" height="12" src="images/all-addon-icon.svg" data-pin-nopin="true"><div class="link-hover service-name">All Addons,</div></a><div class="popup service-name" style="margin-top: 3px;">Priority E-mail Support</div></div><div class="popup tiered-value w-clearfix" style="margin-left: -76px;"><span class="dollor-sign popup" style="margin-top: 4px;">$</span>'+addonSuitePrice+'</div><div class="plan-valid-year"></div><div class="popup tiered-renews-price-value">renews @ $'+priceForAllPlans.renewPriceForFreelancer+' yearly</div></div>';
				var upgradeToSuiteURL = IWPSiteURL+'?add-to-cart='+IDForAllPlans.IDForAgency+'&utm_source=application&utm_medium=userapp&utm_campaign=agency';
				var additionalMessage = 'Your Freelancer plan license allows you to manage only '+miniSiteLimit+' sites.<br>';
				var suggestPlan = 'Agency';
				var suggestSite = 'Unlimited';
			}	
		}
		...
		switch(mode) {
			case 'addonSuiteLimitExceededIllegally':
				restrictionContent+='<div class="dialog_cont" style="width: 500px;">'+
										...
										'<div style="padding:20px;" class="">'+
											'<div style="text-align:center; line-height: 22px;" id="removeSiteCont">'+
												'It looks like you are using the '+activeTierPlan+' license on more than '+miniSiteLimit+' sites.<br />'+
												'With your '+activeTierPlan+' license, you can use the addons to manage only upto '+miniSiteLimit+' sites.<br /><br />'+
												'Either remove a few sites and bring it down to '+miniSiteLimit+' or<br />'+
												'<a href="'+upgradeToSuiteURL+'" target="_blank">'+
													'Upgrade to '+suggestPlan+
												'</a> '+ 
												'for $'+addonSuitePrice+' to use the addons for '+suggestSite+' sites.'+'<br>Check out <a id="iwpAddonsBtn">Other plans</a> on addons page '+
											'</div>'+
			...
			case 'installAddons':
				restrictionContent+='<div class="dialog_cont" style="width: 500px;">'+
										...
										'</div>'+
										'<div style="padding:20px;" class="">'+
											'<div style="text-align:center; line-height: 22px;" id="removeSiteCont">'+additionalMessage+
											'</div>'+
											'<table style="width:320px; margin:20px auto;">'+
												'<tbody>'+
													'<tr>'+
														'<td>'+
															'<div class="btn_action float-right"></div>'+
														'</td>'+
														'<td align="center">'+planRecomend+
																'</a>'+
															'</div>'+
														'</td>'+
													'</tr>'+
												'</tbody>'+
											'</table>'+'<table style="width: 320px;margin: 20px auto;"><tbody><tr><td><div class="btn_action float-right" style="margin-right: 65px;"><a class="rep_sprite cancel" style="color: #6C7277;">No! Dont.</a></div><div class="btn_action float-right" style="cursor:pointer;"><a class="rep_sprite btn_blue " href="'+IWPSiteURL+'pricing" style="color: #6C7277;  cursor:pointer;">UPGRADE.</a></div></td></tr></tbody></table>'+
											'<div class="clear-both"></div>'+
										'</div>'+
										'<div class="clear-both"></div>'+
									'</div>';				
										...
										'<div style="padding:20px;">'+
											...
											'<table style="width:320px; margin:20px auto;">'+
												'<tbody>'+
													...
													'</tr>'+
												'</tbody>'+
											'</table>'+'<table style="width: 320px;margin: 20px auto;"><tbody><tr><td><div class="btn_action float-right" style="margin-right: 65px;"><a class="rep_sprite cancel" style="color: #6C7277;">No! Dont.</a></div><div class="btn_action float-right" style="cursor:pointer;"><a class="rep_sprite btn_blue " href="'+upgradeToSuiteURL+'" target="_blank" style="color: #6C7277;  cursor:pointer;">UPGRADE.</a></div></td></tr></tbody></table>'+
											'<div class="addon-suite-mini-instructions-wrapper addon-suite-mini-cancellation-wrapper">Are you looking at managing unlimited site? </div><div class="addon-suite-mini-instructions-wrapper addon-suite-mini-cancellation-wrapper make-bold">Check out <a id="iwpAddonsBtn">Other plans</a> on addon page</div>'+											
										'</div>'+
										'<div class="clear-both"></div>'+
									'</div>';				
			break;
...
function getSettingsContent(cat){
	...
	content += '<div class="settings_wrapper">';
		if(currentUserAccessLevel=='admin') {
			content += '<ul class="settings_nav"><li>Account</li><li>App</li><li>Security</li><li>Email Settings</li><li>Cron</li>'+googleSettings+scheduledBackupSettings+cpBrandingSettings+uptimeMonitoringSettings+stagingSettings+'<li>App Update</li><li>Connection Method</li></ul>';
