...
//subject starts here
if(empty($siteView)){ ?>InfiniteWP | Everything is up to date.<?php } elseif(!empty($d['sitesUpdates']['totalVulnsCount']) && !$d['onlyVulnsUpdate']){ ?> InfiniteWP | Vulnerability Updates / New Updates Available <?php }elseif(!empty($d['sitesUpdates']['totalVulnsCount']) && $d['onlyVulnsUpdate']){ ?> InfiniteWP | Vulnerability Updates Available  <?php }else { ?>InfiniteWP | New Updates Available.<?php }
